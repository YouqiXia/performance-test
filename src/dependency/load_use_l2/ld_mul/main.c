/* Dependency test: LD↔MUL (L2) forwarding chain */
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
#include <string.h>
...
extern void test_ld_mul(uint64_t nloop, void *head);
...
int main(void)
{
    ...
    test_ld_mul(1000, chain);
    perf_start(&ctx);
    test_ld_mul(NLOOP, chain);
    perf_stop(&ctx, &cycles, &instret);
    perf_print("LD<->MUL L2", cycles, instret,
