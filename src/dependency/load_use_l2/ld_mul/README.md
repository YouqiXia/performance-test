...
|---------|-----|-------|---------------|------|
| ld_mul  | ✅  | 100   | 2             | ld→mul 往返链 (L2) |

## 解读

- cycles/iter - ld_ld(L2) baseline = MUL latency + forwarding overhead
